...
pub fn open_position<S: Storage, A: Api, Q: Querier>(
    ...
    // Calculate collateral effective ratio
    let effective_cr: Decimal = decimal_multiplication(collateral_ratio, collateral_multiplier);
...
pub fn auction<S: Storage, A: Api, Q: Querier>(
    ...
    // asset_amount * price_to_collateral * auction_threshold * collateral_multiplier > collateral_amount
    let asset_value_in_collateral_asset: Uint128 =
